...
def get_args_parser():
    ...
    parser.add_argument('--keypoints', default=True, action='store_true',
                        help="Train keypoints head if the flag is provided")

    # Loss
    parser.add_argument('--no_aux_loss', default=False, dest='aux_loss', action='store_true',
...
def main(args):
    ...
    lr_scheduler = torch.optim.lr_scheduler.StepLR(optimizer, args.lr_drop, 0.5)
    #lr_scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, factor=0.5, patience=args.lr_drop)
    ...
    copytree('../GalDETR', f'{args.output_dir}/GalDETR', ignore=ignore_patterns('RadioGalaxyNET', 'RadioGalaxyNET_V4', 'outputs_gal'), dirs_exist_ok=True)
